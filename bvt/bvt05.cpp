...
static void TestEqualRange (rcintvec_t v)
{
    ...
    rv = equal_range (v, 10);
    cout.format ("Range of  10 is { %2d, %2d }\n", abs_distance (v.begin(), rv.first), abs_distance (v.begin(), rv.second));
    rv = equal_range (v, 0);
    cout.format ("Range of   0 is { %2d, %2d }\n", abs_distance (v.begin(), rv.first), abs_distance (v.begin(), rv.second));
    rv = equal_range (v, 100);
    cout.format ("Range of 100 is { %2d, %2d }\n", abs_distance (v.begin(), rv.first), abs_distance (v.begin(), rv.second));
}
...
void TestAlgorithms (void)
{
    ...
    cout << "find(10)\n";
    cout.format ("10 found at offset %d\n", abs_distance (v.begin(), find (v, 10)));

    cout << "count(13)\n";
    cout.format ("%u values of 13, %u values of 18\n", count(v,13), count(v,18));
