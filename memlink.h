...
/** Implementation of memory exceptions (all USTL memory allocation is within 
 	memblock and memlink)
*/
#ifdef __SYMBIAN32__
#include <e32std.h>
#define __THROW_BAD_ALLOC( n )	User::Leave( KErrNoMemory )
#else
#define __THROW_BAD_ALLOC( n )	throw bad_alloc (n)
#endif
